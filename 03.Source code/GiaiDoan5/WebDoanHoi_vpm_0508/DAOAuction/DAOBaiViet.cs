...
namespace DAOAuction
{
    public class DAOBaiViet
    {
        ...
        public BAIVIET LayBaiVietMoiNhatTheoChuyenMuc(int MaChuyenMuc)
        {
            ...
            using (LinQDataContext db = new LinQDataContext(global::DAOAuction.Properties.Settings.Default.webdoantruongConnectionString))
            {
                ISingleResult<BAIVIET_LayBaiVietMoiNhatTheoChuyenMucResult> lp = db.BAIVIET_LayBaiVietMoiNhatTheoChuyenMuc(MaChuyenMuc);

                
                foreach (BAIVIET_LayBaiVietMoiNhatTheoChuyenMucResult bv in lp)
                {
                    //BAIVIET_LayBaiVietMoiNhatResult bv = temp[i];
                    BAIVIET var1 = new BAIVIET();
                    var1.MaBaiViet = bv.MaBaiViet;
