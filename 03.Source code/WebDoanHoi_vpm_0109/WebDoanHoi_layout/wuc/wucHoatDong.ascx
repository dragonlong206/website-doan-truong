<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucHoatDong.ascx.cs" Inherits="WebDoanHoi_layout.wuc.wucHoatDong" %>
<div class="section-title">
    ...
    <asp:GridView ID="GridViewHoatDong" runat="server" 
                ...
                DataKeyNames="mahoatdong" AllowPaging="True" 
