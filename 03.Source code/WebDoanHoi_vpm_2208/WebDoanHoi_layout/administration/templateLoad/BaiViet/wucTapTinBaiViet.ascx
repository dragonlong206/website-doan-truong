<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucTapTinBaiViet.ascx.cs" Inherits="WebDoanHoi_layout.administration.templateLoad.BaiViet.wucTapTinBaiViet" %>
            ...
            onrowcommand="GridViewTapTin_RowCommand">             
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="tentaptin" HeaderText="Tập tin" 
                        ...
                        DataNavigateUrlFormatString="~/TapTinBaiViet.aspx?id={0}" 
                        ItemStyle-Width="30%" SortExpression="mataptin" >
                        <ItemStyle Width="30%" />
                     </asp:HyperLinkField>
                     
                    <asp:HyperLinkField  HeaderText="Đường dẫn" DataNavigateUrlFields="duongdan" DataTextField="tentaptin" />
                    <asp:BoundField DataField="mabaiviet" HeaderText="Mã bài viết" />
                    <asp:ButtonField CommandName="XoaTapTin" HeaderText="Xóa Tập Tin" Text="Xóa" />
                </Columns>
    </asp:GridView>       
