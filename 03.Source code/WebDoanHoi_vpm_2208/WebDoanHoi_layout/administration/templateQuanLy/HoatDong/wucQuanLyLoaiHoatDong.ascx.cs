    ...
    public partial class wucQuanLyLoaiHoatDong : System.Web.UI.UserControl
    {
        ...
        protected void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult rs = MessageBox.Show("Bạn có chắc là muốn xoá Hoạt Động <" + txttenloaihoatdong.Text + "> không?", "Warning!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
