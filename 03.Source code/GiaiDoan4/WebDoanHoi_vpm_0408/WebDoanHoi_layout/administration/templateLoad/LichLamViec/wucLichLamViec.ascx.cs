    ...
    public partial class wucLichLamViec : System.Web.UI.UserControl
    {
        ...
        public int LoadTAPTINBAIVIET()
        {
            ...
            if (lt.Count > 0)
            {
                ...
                //GridViewTAPTINBAIVIET
                //HyperLinkField field = new HyperLinkField();
                //field.DataTextField = "TenTapTin";
                //field.DataNavigateUrlFields = "MaTapTin";
                //field.DataNavigateUrlFormatString = "~/administration/LichLamViec.aspx?id={0}";
                //GridViewTAPTINBAIVIET.Columns.Add(field);
