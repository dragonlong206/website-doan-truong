<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucBaiViet.ascx.cs" Inherits="templates_wucBaiViet" %>
    ...
    <asp:GridView ID="GridViewBaiViet" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="tieude" HeaderText="Tiêu Đề" 
                        NavigateUrl="~/Default.aspx" DataNavigateUrlFields="mabaiviet" 
                    ...
                    <asp:BoundField DataField="maloaibaiviet" HeaderText="Mã loại bài viết" />
