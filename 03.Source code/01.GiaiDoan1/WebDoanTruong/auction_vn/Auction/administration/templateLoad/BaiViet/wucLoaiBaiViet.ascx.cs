...
public partial class templates_wucLoaiBaiViet : System.Web.UI.UserControl
{
    ...
    {
        List<LOAIBAIVIET> lt = new List<LOAIBAIVIET>();

        BUSLoaiBaiViet BUSLoaiBaiViet = new BUSLoaiBaiViet();

        lt = BUSLoaiBaiViet.SelectLOAIBAIVIETsAll();
        if (lt.Count > 0)
        {
