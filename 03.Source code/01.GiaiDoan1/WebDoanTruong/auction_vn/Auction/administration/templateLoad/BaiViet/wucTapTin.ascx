<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucTapTin.ascx.cs" Inherits="templates_wucTapTin" %>
    ...
    <asp:GridView ID="GridViewTapTin" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="tentaptin" HeaderText="Tập tin" 
                        ...
                        DataNavigateUrlFormatString="~/administration/TapTin.aspx?id={0}" 
