<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_default.aspx.cs" Inherits="WebDoanHoi_layout.index" %>
<%@ Register TagPrefix="Auction" TagName="Testwuc" Src="~/Test_WebUserControl.ascx"%>
    ...
    <div id="wrapper">
        ...
        <div id="content">
            <div id="posts">
                ...
                <ContentTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Chuyên Mục 1</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Chuyên Mục 2</asp:LinkButton>
                ...
                <ContentTemplate>
                <Auction:Testwuc ID="Testwuc" Runat="Server" />
                </ContentTemplate>
                </asp:UpdatePanel>
        ...
        <div id="footer">
            <p>
                ...
                Điện thoại: (08) 3835 4008 | Email: doantn@hcmuns.edu.vn | Địa chỉ: 227 N&nbsp;&nbsp; guyễn Văn
                Cừ, Q5, TP.HCM<br />
            </p>
        </div>
        <!-- footer end -->
