<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl1.ascx.cs" Inherits="WebDoanHoi_layout.administration.templateLoad.HoatDong.WebUserControl1" %>
