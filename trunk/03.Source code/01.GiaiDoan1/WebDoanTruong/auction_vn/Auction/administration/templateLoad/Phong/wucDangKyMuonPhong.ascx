<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucDangKyMuonPhong.ascx.cs" Inherits="templates_wucDangKyMuonPhong" %>
<div class="section-title">
    ...
    <asp:GridView ID="GridViewDangKyMuonPhong" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ngay" HeaderText="Ngày Mượn"/>
