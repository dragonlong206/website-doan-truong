<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucThongBao.ascx.cs" Inherits="templates_wucThongBao" %>
<div class="section-title">
    ...
    <asp:GridView ID="GridViewThongBao" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="mahoatdong" HeaderText="Hoạt Động"/>
                </Columns>
    </asp:GridView>       
