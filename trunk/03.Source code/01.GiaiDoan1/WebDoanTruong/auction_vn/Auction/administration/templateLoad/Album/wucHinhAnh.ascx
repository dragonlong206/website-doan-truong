<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucHinhAnh.ascx.cs" Inherits="administration_templateLoad_Album_wucHinhAnh" %>
<div class="section-title">
    ...
    <asp:GridView ID="GridViewHinhAnh" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="hinhanh" HeaderText="Tên Hình Ảnh" 
                        NavigateUrl="~/Default.aspx" DataNavigateUrlFields="hinhanh" 
