<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucHeThongToChuc.ascx.cs" Inherits="templates_wucHeThongToChuc" %>
<div class="section-title">
    ...
    <asp:GridView ID="GridViewHeThongToChuc" runat="server" 
                ...
                CssClass="tablestyle" DataKeyNames="mahethongtochuc" AllowPaging="True" 
                onpageindexchanging="GridViewHeThongToChuc_PageIndexChanging">             
                <Columns>
                    <asp:BoundField HeaderText="STT" />
                    <asp:BoundField DataField="mahethongtochuc" HeaderText="Hệ thống tổ chức" Visible ="false" />
                    
                    <asp:HyperLinkField DataTextField="tenhethongtochuc" HeaderText="Hệ thống tổ chức" 
                        NavigateUrl="~/Default.aspx" DataNavigateUrlFields="mahethongtochuc" 
                        DataNavigateUrlFormatString="~/administration/HeThongToChuc.aspx?id={0}" 
                        ItemStyle-Width="30%" SortExpression="mahethongtochuc" >
                        <ItemStyle Width="30%" />
                     </asp:HyperLinkField>
