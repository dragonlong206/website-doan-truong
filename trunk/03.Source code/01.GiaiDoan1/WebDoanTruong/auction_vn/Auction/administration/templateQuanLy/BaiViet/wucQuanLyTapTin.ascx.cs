...
public partial class administration_templateQuanLy_BaiViet_wucQuanLyTapTin : System.Web.UI.UserControl
{
    #region Ham Chung
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            TAPTIN lpDTO = BUSTapTin.TimKiem(mataptin);
