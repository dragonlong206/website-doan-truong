...
public partial class administration_templateQuanLy_KhaoSat_wucQuanLyDapAnKhaoSat : System.Web.UI.UserControl
{
    #region Ham Chung
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            txtmadapankhaosat.Text = lpDTO.madapankhaosat.ToString();
            txtmakhaosat.Text = lpDTO.makhaosat.ToString();
    ...
    protected void btnCapNhat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lpDTO.madapankhaosat = int.Parse(txtmadapankhaosat.Text);
            lpDTO.makhaosat = int.Parse(txtmakhaosat.Text);
