...
public partial class administration_templateQuanLy_HoatDong_wucQuanLyDangKyHoatDong : System.Web.UI.UserControl
{
    #region Ham Chung
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            txtngaydangky.Text = lpDTO.ngaydangky.ToString();
            txtthamgia.Text = lpDTO.thamgia;
        }
    }
    ...
    protected void btnCapNhat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lpDTO.ngaydangky = DateTime.Parse(txtngaydangky.Text);
            lpDTO.thamgia = txtthamgia.Text;
    ...
    protected void btnXoa_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rs == DialogResult.Yes)
            {
                //Goi ham xoa
                BUSDangKyHoatDong BUSDangKyHoatDong = new BUSDangKyHoatDong();
                if (BUSDangKyHoatDong.Xoa(mahoatdong) == 0)
                {
                    //Thong bao
