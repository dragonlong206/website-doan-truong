<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucDangKyMuonPhong.ascx.cs" Inherits="WebDoanHoi_layout.administration.templateLoad.Phong.wucDangKyMuonPhong" %>
<div class="section-title">

            <asp:Image ID="imgTitle" runat="server" ImageUrl="~/administration/Common/ico-dashboard.png" />
            <asp:Label ID="lblTitle" runat="server" Text="Danh Sách Đăng Ký Mượn Phòng" Font-Bold="True" Font-Size="Large" ForeColor="Blue"></asp:Label>
    </div>   
    ...
    <asp:GridView ID="GridViewDangKyMuonPhong" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="madangky" HeaderText="Đăng Ký Mượn Phòng" Visible ="false" />
                    
                    <asp:HyperLinkField DataTextField="manguoidung" HeaderText="Mã Sinh Viên" 
                    ...
                    <asp:BoundField DataField="soluong" HeaderText="Số Lượng Sinh Viên" />
